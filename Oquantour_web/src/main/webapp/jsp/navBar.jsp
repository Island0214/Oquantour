                ...
                <div class="userDiv" style="display: none">
                    ...
                    <div class="userInfoDiv" align="left">
                        ...
                        <div class="personalHomeDiv">
                            ...
                            <a href="/jsp/userHomepage.jsp" style="text-decoration: none;font-size: 16px;color: #95a6b3;font-weight: 300">我的主页</a>
                        </div>

                        <div class="personalSettingDiv">
                            <a href="/jsp/personalInfo.jsp" style="text-decoration: none;font-size: 16px;color: #95a6b3;font-weight: 300">个人设置</a>
                        </div>
